                  ...
                  {selectedProduct && (
                    <>
                      ...
                      <div className="mt-2">
                        ...
                        <p className="mb-2"><strong>Descripción:</strong> {selectedProduct.description}</p>
                        <p className="mb-2"><strong>Precio:</strong> ${selectedProduct.price}</p>
                        <p className="mb-2"><strong>En existencia:</strong> {selectedProduct.stock} unidades</p>
                      ...
                      <div className="mt-4 flex justify-between">
                        ...
                        <button
                          ...
                          onClick={() => {
                            // Aquí iría la lógica de compra si quisieras implementarla
                            console.log("Compra simulada para:", selectedProduct.name);
                          }}
                        >
                          Comprar
                        </button>
