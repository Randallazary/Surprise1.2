    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      {loading ? (
            ...
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                  {politicas.title || "Términos y Condiciones"}
                </h1>
                <div className="flex items-center text-blue-100">
                  ...
                  <span className="text-sm sm:text-base">
                    Vigente desde: {politicas.effectiveDate ? new Date(politicas.effectiveDate).toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric' }) : "No disponible"}
                  </span>
                </div>
              </div>
        ...
        <div className="max-w-md mx-auto bg-white p-8 rounded-xl shadow-md text-center">
          ...
          <p className="mt-2 text-gray-600">No se pudieron cargar los términos y condiciones. Por favor, inténtalo de nuevo más tarde.</p>
          <button
